...
import { V2ProcessRail, V2TechnologyTopology, V2Cta } from '@/components/v2/enterprise-visuals'

export const metadata: Metadata = {
  title: 'Our Approach | Synova Infotech',
  description: 'Discover how Synova Infotech builds enterprise-grade software and drives digital transformation.',
}
      ...
      <section className="relative overflow-hidden bg-[var(--color-surface-secondary)] py-20 md:py-28">
        ...
        <div className="relative mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mx-auto max-w-2xl text-lg leading-relaxed text-[var(--color-text-secondary)] md:text-xl">
            We combine strategic vision with engineering excellence to deliver enterprise solutions that scale gracefully and drive measurable business impact.
          </p>
        </div>
      </section>
