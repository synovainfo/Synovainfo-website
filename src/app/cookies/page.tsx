...
export async function generateMetadata(): Promise<Metadata> {
  const page = await prisma.page.findFirst({
    where: {
      OR: [{ template: 'cookies' }, { slug: 'cookies' }],
      status: 'PUBLISHED',
      deletedAt: null,
    },
  ...
  return {
    title: page?.title ? `${page.title} | Synova Infotech` : 'Cookie Policy | Synova Infotech',
    description:
      page?.excerpt ??
      'Learn how Synova Infotech uses cookies, web beacons, and similar technologies to enhance your browsing experience and improve our services.',
  }
}
