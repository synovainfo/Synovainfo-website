<section class="relative py-24 md:py-32 bg-canvas border-t border-ink/5 dark:border-white/5" aria-label="Why choose Synova">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-20">
            <p class="eyebrow text-ember-500 mb-6 tracking-widest uppercase text-sm font-semibold">Why choose Synova</p>
