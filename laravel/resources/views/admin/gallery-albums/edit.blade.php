<x-admin-layout>
    <x-slot name="title">Edit Gallery Album</x-slot>

    <x-admin.page-header title="Edit Gallery Album">
    ...
    <form action="{{ route('admin.gallery-albums.update', $galleryAlbum) }}" method="POST" class="bg-white shadow-sm ring-1 ring-slate-900/5 sm:rounded-xl md:col-span-2 mt-6">
        @csrf
        @method('PUT')
