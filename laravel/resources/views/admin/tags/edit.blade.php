<x-admin-layout>
    ...
    <x-admin.page-header title="Edit Tag">
    ...
    <form action="{{ route('admin.tags.update', $tag) }}" method="POST" class="bg-white shadow-sm ring-1 ring-slate-900/5 sm:rounded-xl md:col-span-2 mt-6">
        @csrf
        @method('PUT')
