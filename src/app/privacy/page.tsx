...
export async function generateMetadata(): Promise<Metadata> {
  const page = await prisma.page.findFirst({
    where: {
      OR: [{ template: 'privacy' }, { slug: 'privacy' }],
      status: 'PUBLISHED',
      deletedAt: null,
    },
  ...
  return {
    title: page?.title ? `${page.title} | Synova Infotech` : 'Privacy Policy | Synova Infotech',
    description:
      page?.excerpt ??
      'Synova Infotech\'s privacy policy outlines how we collect, use, and protect your personal information.',
  }
}
