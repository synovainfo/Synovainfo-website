<x-admin-layout>
    <x-slot name="title">Create Solution</x-slot>

    <x-admin.page-header title="Create Solution">
    ...
    <form action="{{ route('admin.solutions.store') }}" method="POST" class="bg-white shadow-sm ring-1 ring-slate-900/5 sm:rounded-xl md:col-span-2 mt-6">
        @csrf
