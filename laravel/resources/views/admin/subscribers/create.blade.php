<x-admin-layout>
    ...
    <x-admin.page-header title="Create Subscriber">
    ...
    <form action="{{ route('admin.subscribers.store') }}" method="POST" class="bg-white shadow-sm ring-1 ring-slate-900/5 sm:rounded-xl md:col-span-2 mt-6">
        @csrf
