<x-admin-layout>
    <x-slot name="title">Edit Technology</x-slot>

    <x-admin.page-header title="Edit Technology">
    ...
    <form action="{{ route('admin.technologies.update', $technology) }}" method="POST" class="bg-white shadow-sm ring-1 ring-slate-900/5 sm:rounded-xl md:col-span-2 mt-6">
        @csrf
        @method('PUT')
