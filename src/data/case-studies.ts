export interface CaseStudy {
  ...
  timeline: string
  architecture: 'manufacturing' | 'supply-chain' | 'financial'
}
...
export const caseStudies: CaseStudy[] = [
  {
    ...
    overview:
      'Complete ERP integration with IoT sensor network and real-time analytics dashboard for a Fortune 500 manufacturer. Legacy silos eliminated, production data unified, and decision latency reduced from days to seconds.',
    challenge:
      'The client operated 14 plants across 6 countries, each running independent legacy systems for inventory, production scheduling, quality control, and maintenance. Data lived in disconnected silos — SAP instances, custom .NET applications, spreadsheets, and paper logs. Plant managers made decisions on 3-day-old data, resulting in costly overstocking, undetected quality deviations, and reactive maintenance that caused 180+ hours of unplanned downtime per quarter.',
    solution:
      'We deployed a unified event-driven architecture connecting every plant floor via IoT sensor gateways. Apache Kafka streams production metrics, quality readings, and equipment telemetry into a real-time analytics pipeline. A React-based command center dashboard gives operations leadership a single pane of glass across all 14 plants, with AI-powered anomaly detection flagging deviations before they become incidents.',
    technologies: [
      'Java',
      'Spring Boot',
      'React',
  ...
  },
  {
    ...
    results: [
      { metric: 'Logistics Cost Reduction', value: '-28%' },
      { metric: 'On-Time Delivery', value: '98.5%' },
      { metric: 'Empty-Run Reduction', value: '-65%' },
    ],
    timeline: '7 months — Pilot to Full Rollout',
  ...
  },
  {
    ...
    results: [
      ...
      { metric: 'Infra Cost Reduction', value: '-40%' },
      { metric: 'Release Cadence', value: '2 weeks' },
    ],
    timeline: '12 months — Assessment to Cutover',
