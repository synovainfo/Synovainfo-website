  ...
  const content = (
    <div
      className={cn(
        ...
        'hover:border-[var(--color-corporate-gold)]/30 hover:shadow-lg',
        href && 'cursor-pointer',
      )}
    >
      ...
      <div
        className={cn(
          ...
          'bg-gradient-to-br from-[var(--color-corporate-gold)]/[0.04] to-[var(--color-accent-cyan)]/[0.04]',
      ...
      <div className="relative z-10 flex items-start gap-4">
        ...
        <div
          className={cn(
            ...
            'bg-gradient-to-br from-[var(--color-corporate-gold)]/10 to-[var(--color-accent-cyan)]/10',
            'text-[var(--color-corporate-gold)] transition-colors duration-300',
            'group-hover:from-[var(--color-corporate-gold)]/20 group-hover:to-[var(--color-accent-cyan)]/20',
        ...
        {href && (
          <ArrowUpRight
            className={cn(
              ...
              'transition-all duration-300',
              'group-hover:text-[var(--color-corporate-gold)] group-hover:translate-x-0.5 group-hover:-translate-y-0.5',
            )}
          />
        )}
      </div>
