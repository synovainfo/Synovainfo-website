<section class="py-24 bg-orange-500 text-white relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-4xl mx-auto px-6 text-center">
        <p class="text-xs font-bold uppercase tracking-[0.25em] text-white/80 mb-6">Enterprise Consultation</p>
        <h2 class="text-3xl md:text-5xl font-extrabold tracking-tight leading-tight mb-10">
