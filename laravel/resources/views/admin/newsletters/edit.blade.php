<x-admin-layout>
    ...
    <x-admin.page-header title="Edit Newsletter">
    ...
    <form action="{{ route('admin.newsletters.update', $newsletter) }}" method="POST" class="bg-white shadow-sm ring-1 ring-slate-900/5 sm:rounded-xl md:col-span-2 mt-6">
        @csrf
        @method('PUT')
